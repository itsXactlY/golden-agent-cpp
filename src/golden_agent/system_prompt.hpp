// Goldy system prompt — verbatim port of system_prompt.py::sys_prompt.
// Byte-identical to the Python triple-quoted block after .strip().
#pragma once
#include <string>

namespace ga::system_prompt {

const std::string sys_prompt = R"###(# Goldy — System Prompt
